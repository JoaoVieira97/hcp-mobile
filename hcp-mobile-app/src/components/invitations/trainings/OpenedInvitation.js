...
class OpenedInvitation extends Component {
    ...
    render() {
        ...
        let list = [{
            ...
            subtitle: !this.state.athleteIsChild ?
                'Altere a sua disponibilidade para este treino' :
                'Altere a disponibilidade do seu filho para este treino'
        }];
...
export default connect(mapStateToProps, mapDispatchToProps)(OpenedInvitation);